...
const Hero = () => {
    return(
        <div className="text-centerlg:flex lg:justify-center h-3/4 bg-blue-400">
            ...
            <img src="https://i.postimg.cc/GmjPjg63/Untitled-design-7.png" className="h-3/4"></img>

            <div className="block lg:hidden text-left my-auto pl-24">
